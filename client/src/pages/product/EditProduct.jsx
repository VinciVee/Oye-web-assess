...
function EditProduct() {
  ...
  // oldImageId from Existing downloadURL
  ...
  // Only fetches product under specific conditions
    ...
    <OyezCard title="Edit Product Details">
      <Form onSubmit={ handleSubmit }>
        ...
        <Form.Group className="mb-3">
          ...
          {/* END OF PRODUCT PRICE ROW */}
          </Row>
        </Form.Group>

        {/* GROUP 5: PRODUCT IMAGE & AVAILABILITY */}
        {/* GROUP 5A: CONDITIONAL PREVIEW OF IMAGE (File in DB) */}
        { preview && !loading ? <div>
          <h6>Current Image</h6>
