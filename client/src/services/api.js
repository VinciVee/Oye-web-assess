...
// AXIOS RESPONSE (INTERCEPTOR): Allows errors to be intercepted globally and displays messages with Reach Toast
api.interceptors.response.use(null, (error) => {
  ...
  if (!expectedError) {
    ...
    // STANDARDISED: By creating uniform erorr responses, like our backend, we can standardise our errors on the front end
